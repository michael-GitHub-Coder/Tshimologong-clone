...
const Hero = () => {
  ...
  return (
    <div>
      ...
      <div className="md:hidden inset-x-2 flex flex-col mt-2 gap-4 px-5">
      ...
      <div className="px-5 mt-5 md:absolute inset-x-2 md:inset-x-0 flex flex-col md:flex-row justify-center md:gap-8 gap-2 md:-mt-20">
