    ...
    <div className="container mx-auto gird-cols-1 mt-20 md:mt-64">
         <div style={{ backgroundImage: `url(${pic1})`,backgroundSize: 'cover', backgroundPosition: 'center',}} className="object-cover h-[200px] md:h-[200px]  mt-10">
            ...
            <div className="flex justify-center text-white px-5">
                <button className="w-full md:block border-2 border-white px-5 py-1 text-md mt-5">DOWNLOAD REPORT</button>
            </div>
        </div>
        <div className="md:flex gap-8">
            <div style={{ backgroundImage: `url(${pic1})`,backgroundSize: 'cover', backgroundPosition: 'center',}} className="object-cover h-[200px] md:h-[200px] md:w-1/2  mt-10">
                ...
                <div className="flex justify-center text-white px-5">
                    <button className="w-full md:block border-2 border-pink-400 px-5 py-1 text-md mt-5">DOWNLOAD REPORT</button>
                </div>
            </div>
            <div style={{ backgroundImage: `url(${pic1})`,backgroundSize: 'cover', backgroundPosition: 'center',}} className="object-cover md:w-1/2 h-[200px] md:h-[200px]  mt-10">
                ...
                <div className="flex justify-center text-white px-5">
                    <button className="w-full md:block border-2 border-orange-600 px-5 py-1 text-md mt-1">DOWNLOAD REPORT</button>
                </div>
            </div>
        </div>
        ...
        <div className="md:flex gap-8">
            <div style={{ backgroundImage: `url(${pic1})`,backgroundSize: 'cover', backgroundPosition: 'center',}} className="object-cover h-[200px] md:h-[200px] md:w-1/2  mt-10">
                ...
                <div className="flex justify-center text-white px-5">
                    <button className="w-full md:block border-2 border-orange-600 px-5 py-1 text-md mt-5">DOWNLOAD REPORT</button>
                </div>
            </div>
            <div style={{ backgroundImage: `url(${pic1})`,backgroundSize: 'cover', backgroundPosition: 'center',}} className="object-cover md:w-1/2 h-[200px] md:h-[200px]  mt-10">
